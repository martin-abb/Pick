...
%   Martin Krucinski
%
%   v_004 is used by a sweep algorithm to return tf (almost as a
%   function...)
%   Input arguments are:
%       v_coll
%       delta_1
%   
%   used with sweep_analyze_v004l
%   Parameters are for an IRB 1600 executing pick & place
%   between two bins on opposite sides, approx. 160 degrees an arc
...
a_max   = 20;%***2.0*g;      % [m/s^2]       Max acceleration
v_max   = 2.6; %***3;        % [m/s]         Max velocity
...
x2      = 3490*mm; %***600*mm;   % [m]       Item 2 location
